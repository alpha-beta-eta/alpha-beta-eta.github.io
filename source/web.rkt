...
(define (emit-web)
  (parameterize ([replace? #t])
    ...
    (emitXml seplogic_notes.html
             "../seplogic_notes.html")
    (emitXml lax.html "../lax.html")
    (emitXml seplogic.html "../seplogic.html")
    (emitXml differential.html
             "../differential.html")
    (emitXml matrix.html "../matrix.html")
    (emitXml global_calculus.html
             "../global_calculus.html")
    (emitXml diary.html "../diary.html")
    ...
    (emitXml context.html "../context.html")
    (emitXml smathml1.html "../smathml1.html")
    (emitXml gtm5.html "../gtm5.html")
    (emitXml exercises_in_programming.html
             "../exercises_in_programming.html")
    (emitXml smathml0.html "../smathml0.html")
    (emitXml contract.html
             "../contract.html")
    (emitXml napier.html "../napier.html")
    (emitXml coalgebra.html
             "../coalgebra.html")
  ...
  (emitXml-thunk
   ...
   "../topos.html")
  (emitXml-thunk
   thunk:proof_theory_and_algebra_in_logic.html
   "../proof_theory_and_algebra_in_logic.html")
  (emitXml-thunk thunk:measure.html
                 "../measure.html")
  (emitXml-thunk
   thunk:denotational_semantics_notes.html
   "../denotational_semantics_notes.html")
  (emitXml-thunk thunk:tapl.html
                 "../tapl.html")
  (emitXml-thunk thunk:cat_awodey.html
                 "../cat_awodey.html")
  ...
  (emitXml-thunk
   thunk:linear_algebra_exercises.html
   "../linear_algebra_exercises.html")
  ...
  (emitXml-thunk thunk:curry-howard.html
                 "../curry-howard.html")
  ...
  (emitXml-thunk thunk:hott.html
                 "../hott.html")
  (emitXml-thunk
   thunk:exercises_in_analysis.html
   "../exercises_in_analysis.html")
  ...
  (emitXml-thunk thunk:p423.html
                 "../p423.html")
  (emitXml clos.html "../clos.html")
  (emitXml-thunk thunk:little_typer.html
                 "../little_typer.html")
  ...
  (emitXml-thunk thunk:monad.html "../monad.html")
  ...
  (emitXml-thunk
   thunk:linear_logic_notes.html
   "../linear_logic_notes.html")
...
(emit-web)
;#;
(time (parameterize ([replace? #t]
                     [compute-size? #t])
        (emit-web)))
(define (iterate thunk n)
  (if (= n 0)
      (void)
      (begin
        (thunk)
        (iterate thunk (- n 1)))))
;(time (iterate thunk:cat_awodey.html 500))
