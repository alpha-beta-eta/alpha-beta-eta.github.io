...
(define huyan.html
  (TnTmPrelude
   ...
   (Blockquote
    ...
    "&mdash;&mdash; 萧沆")
   (H1 "一些无聊的人生建议和忠告")
   (Ol (Li "如果你读不懂一本书, 那么很有可能不是因为你太过愚蠢, 而是因为作者太过愚蠢.")
       (Li "出于我的个人经验, 烂书分为以下几种: 一是把读者当傻子的, 只说废话; "
           "二是从来不组织文字的, 和流水账没有区别; 三是信奉神秘主义的, "
           "就等着读者来解谜.")
       (Li "不要做无法挽回的事情, 特别是伤害自己的身体这种.")
       (Li "分析学 (我指的是数学上的分支) 还处于它的原始时期, "
           "现在不是研究分析的好时机.")
       (Li "科学分为两种, 一种是需要做实验的, 另一种是不需要做实验的. "
           "如果你想要研究前者, 首先应该做好浪费一生的心理准备. "
           "物理学似乎是唯一的例外, 虽然研究物理也需要实验, "
           "但是物理学家把会浪费生命的东西基本上都开除物理籍了.")
       (Li "当试图完成宏大的计划时, 先从能完成的小事出发. "
           "当试图阅读晦涩难懂的厚书时, 先看能够读懂的地方.")
       (Li "一本数学书籍, 如果其预备部分的内容对于你而言也并非烂熟于心, "
           "那就不要读了, 反正也读不懂. 当然, 唯一的例外可能是一些数学常识, "
           "这个因人而异. 如果你觉得你读不懂的部分都是常识, 那就继续吧.")
       (Li "数学证明是为无法理解的读者准备的, 甚至数学定义也是. "
           "如果你已经充分理解了, 那就不要浪费时间阅读证明了.")
       (Li "物理学家往往会接受数学家觉得不严格的证明, 数学家"
           "往往会接受逻辑学家觉得不严格的证明. 似乎我还忘了哲学家, "
           "哲学家成为了一切思想的垃圾桶, 但是本不该如此.")
       (Li "能够计算是一种非常令人愉悦的性质, "
           "因为这样的话就不需要你计算了.")
       (Li "可复合性也同样令人愉快, 即便看上去没有, 也应该去寻找它. "
           "两种基本的策略, 一种是限制, 另一种是扩张.")
       (Li "对于递归的排斥只是大脑未能发育完全的后遗症.")
