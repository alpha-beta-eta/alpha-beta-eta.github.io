...
(define huyan.html
  (TnTmPrelude
   ...
   (H1 "数学是一种信仰")
   (P "有关数学的一切实际上都是一种信仰. "
      "最直接的一点是, 为什么数学家要相信ZFC是一致的? "
      "而且, 现代数学的一些领域还有可能加上其他一些公理, "
      "为什么数学家相信那些公理体系是一致的?")
   (P "除了一致性问题之外, 数学在自然和先验世界的神秘有效性同样值得注意. "
      "比如说, 为什么我们相信某些数学真的就是"
      "某种切合自然或者非自然本质的形式化? "
      "有时则反过来, 我们需要真正创造数学, "
      "不再像以前有一些显然的对象供我们探索. "
      "这时的问题就更多了, 我们创造的数学究竟是什么东西?")
   (P "对于一个柏拉图主义者, 似乎这一切都没有那么糟糕. "
      "因为他会认为数学是一个独立的先验世界, "
      "数学到目前发展的工具和实践只是探索这个世界的手段. "
      "更强的公理就像望远镜一样, 帮助我们看到更多的东西. "
      "所以说, 我们没有必要太过与数学基础问题较劲. "
      "不过, 对于数学的不合理有效性, 柏拉图主义者不怎么关心.")
   (P "老实说我也没有什么答案, 偶尔我也会陷入一种恐慌的情绪. "
      "那种时候, 我可能会认为一种先验的全知实体是有必要存在的. "
      "不过, 更多的时候, 我完全没考虑过逻辑. "
      "虽然我算是一个直觉主义者, 但是也并不觉得经典逻辑很坏. "
      "说到底, 许多情况下我们真的就是按照需求选取逻辑.")
   (H1 "算法和想法")
