   ...
   (WHILE '(> Y 0)
          ...
          (IF '(= (mod Y 2) 0)
              ...
              (SEQ (:= 'R '(* R X))
                   (:= 'Y '(- Y 1)))))
   '(and (= R (^ a b)) (= Y 0) (>= b 0)))
'((=> (and (= X a) (= Y b) (>= b 0) (= R 1)) (and (= (* R (^ X Y)) (^ a b)) (>= Y 0) (>= b 0)))
  (=>
   (and (and (= (* R (^ X Y)) (^ a b)) (>= Y 0) (>= b 0)) (not (> Y 0)))
   (and (= R (^ a b)) (= Y 0) (>= b 0)))
  (=>
   (and (and (and (= (* R (^ X Y)) (^ a b)) (>= Y 0) (>= b 0)) (> Y 0)) (= (mod Y 2) 0))
   (and (= (* R (^ (* X X) (div Y 2))) (^ a b)) (>= (div Y 2) 0) (>= b 0)))
  (=>
   (and (and (and (= (* R (^ X Y)) (^ a b)) (>= Y 0) (>= b 0)) (> Y 0)) (not (= (mod Y 2) 0)))
   (and (= (* (* R X) (^ X (- Y 1))) (^ a b)) (>= (- Y 1) 0) (>= b 0))))"))
