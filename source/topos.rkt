...
(define-infix*
  (&->hk $->hk)
  (&rrarr $rrarr))
(define (thunk:topos.html)
  (TnTmPrelude
   #:title "Topos: 逻辑的范畴分析"
   #:css "styles.css"
   (H1. "Topos: 逻辑的范畴分析")
   (P "这本书基本上算是第一本关于范畴逻辑的教材, 所以非常温和. "
      "可以看到Steve Awodey的Category Theory对于本书的写法也有不少借鉴.")
   (H2. "数学 = 集合论?")
   (Blockquote
