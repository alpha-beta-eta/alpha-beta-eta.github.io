...
(define cat_awodey.html
  (TmPrelude
   ...
   (P "这本书成长于我过去十年间在CMU教授的范畴论课程. "
      "这这段时间里, 我已经为计算机科学, 数学, 逻辑学的本科生和研究生"
      "教授了无数的讲座课程或者高级讨论班. "
   ...
   (P "当然了, 许多偏序集和幺半群之外的其他例子也有处理. "
      ...
      "作为等化子和余等化子的例子. 这里, 以及偶尔别的什么地方 (例如与Stone对偶的联系), "
