...
(define $9 (Mn &quot;9&quot;))"))
  ...
  (make-table
   ...
   (P (CodeB "(define -- &quot;&amp;mdash;&amp;mdash;&quot;)")
      ...
      "不过我想或许读者也能经常用到.")
   (P (CodeB "(define (enum . x*)
  (apply Span (add-between x* &quot;, &quot;)))")
      (Code "enum") "的功能是用逗号隔开其参数.")
   (H2. "实用定义")
   (P "这一章开始, 我们将诸多实用定义. "
      "其中有些定义充当了基本的工具, "
      "用户同样也可以使用这些工具. "
  ...
  (_^ x i $Prime))")
   ...
   (P "各种字母的所有" (Code "mathvariant")
      ...
      (MB (set-attr*
           ...
           'rowlines "solid"
           'columnlines "solid"))
      "读者应该注意的是, Chrome的MathML Core压根就不支持"
      (Code "mathvariant") ".")
...
(define (&amp;split n)
  (make-op (&amp;space n)
   ...
   (P "各种箭头也是数学中常常使用的, "
      ...
      (MB (set-attr*
           (&Table
            ($rarr (Ms "$rarr") (&rarr $a $b) (Ms "(&amp;rarr $a $b)"))
            ($-> (Ms "$->") (&-> $a $b) (Ms "(&amp;-> $a $b)"))
            ($larr (Ms "$larr") (&larr $a $b) (Ms "(&amp;larr $a $b)"))
            ($<- (Ms "$&lt;-") (&<- $a $b) (Ms "(&amp;&lt;- $a $b)"))
            ($uarr (Ms "$uarr") (&uarr $a $b) (Ms "(&amp;uarr $a $b)"))
            ($darr (Ms "$darr") (&darr $a $b) (Ms "(&amp;darr $a $b)"))
            ($harr (Ms "$harr") (&harr $a $b) (Ms "(&amp;harr $a $b)"))
            ($<-> (Ms "$&lt;->") (&<-> $a $b) (Ms "(&amp;&lt;-> $a $b)"))
            ($rArr (Ms "$rArr") (&rArr $a $b) (Ms "(&amp;rArr $a $b)"))
            ($=> (Ms "$=>") (&=> $a $b) (Ms "(&amp;=> $a $b)"))
            ($lArr (Ms "$lArr") (&lArr $a $b) (Ms "(&amp;lArr $a $b)"))
            ...
            ($hArr (Ms "$hArr") (&hArr $a $b) (Ms "(&amp;hArr $a $b)"))
            ($<=> (Ms "$&lt;=>") (&<=> $a $b) (Ms "(&amp;&lt;=> $a $b)"))
            ($xrarr (Ms "$xrarr") (&xrarr $a $b) (Ms "(&amp;xrarr $a $b)"))
            ($--> (Ms "$-->") (&--> $a $b) (Ms "(&amp;--> $a $b)"))
            ($xlarr (Ms "$xlarr") (&xlarr $a $b) (Ms "(&amp;xlarr $a $b)"))
            ($<-- (Ms "$&lt;--") (&<-- $a $b) (Ms "(&amp;&lt;-- $a $b)"))
            ($xharr (Ms "$xharr") (&xharr $a $b) (Ms "(&amp;xharr $a $b)"))
            ($<--> (Ms "$&lt;-->") (&<--> $a $b) (Ms "(&amp;&lt;--> $a $b)"))
            ($xrArr (Ms "$xrArr") (&xrArr $a $b) (Ms "(&amp;xrArr $a $b)"))
            ($==> (Ms "$==>") (&==> $a $b) (Ms "(&amp;==> $a $b)"))
            ($xlArr (Ms "$xlArr") (&xlArr $a $b) (Ms "(&amp;xlArr $a $b)"))
            ...
            ($xhArr (Ms "$xhArr") (&xhArr $a $b) (Ms "(&amp;xhArr $a $b)"))
            ($<==> (Ms "$&lt;==>") (&<==> $a $b) (Ms "(&amp;&lt;==> $a $b)"))
            ($rrarr (Ms "$rrarr") (&rrarr $a $b) (Ms "(&amp;rrarr $a $b)"))
            ($llarr (Ms "$llarr") (&llarr $a $b) (Ms "(&amp;llarr $a $b)"))
            ($uuarr (Ms "$uuarr") (&uuarr $a $b) (Ms "(&amp;uuarr $a $b)"))
            ($ddarr (Ms "$ddarr") (&ddarr $a $b) (Ms "(&amp;ddarr $a $b)")))
           'columnalign "center left center left"
           'frame "solid"
           'rowlines "solid"
           'columnlines "solid"))
      "其中" (Code "->") "相当于" (Code "rarr") "的别名, "
      (Code "&lt;->") "相当于" (Code "harr") "的别名, "
      (Code "=>") "相当于" (Code "rArr") "的别名, "
      (Code "&lt;=>") "相当于" (Code "hArr")
      "的别名, 诸如此类.")
   (H3. "省略号")
   (P "SMathML提供了几个常见的省略号常量."
      (MB (set-attr*
           (&Table
            ($..h (Ms "$..h"))
            ($..c (Ms "$..c"))
           ...
           'columnlines "solid")))
   (H3. "上划线和下划线")
   (P "SMathML提供了上划线和下划线过程, "
      "未来可能还应该添加用于表达下花括号括起的过程, 等等."
      (CodeB "(define $OverBar (Mo &quot;&amp;OverBar;&quot;))
(define (OverBar x)
  (^^ x $OverBar))
...
(define (UnderBar x)
  (__ x $UnderBar))")
      ...
      (MB (set-attr*
           (&Table
            ((OverBar (&+ $x $y)) (Ms "(OverBar (&amp;+ $x $y))"))
            ((UnderBar (&+ $x $y)) (Ms "(UnderBar (&amp;+ $x $y))")))
           'columnalign "center left"
           'frame "solid"
           'rowlines "solid"
           'columnlines "solid"))
...
(define (Ttable Td)
  ...
  (let iterate ((henv '(0)) (section #f) (genv '()) (lenv '()) (rest exp) (result '()))
    (if (null? rest)
      ...
      "其中"
      (CodeB "(define (make-compatible henv level)
...
(define (H4. #:attr* [attr* '()] #:id [id #f]
  ...
  `(,(build-%heading #:present h4-present #:cite heading-cite
    ...
    ,attr* . ,html*))")
      ...
      "但是未来大概率会删除.")
   (P (Del "至于条目, 目前SMathML还没有提供相关过程. "
           "但是, 在作者书写博客时, 的确产生了一套既定的程序. "
           "问题在于, 作者总是要为每一个页面对其进行小小的修改, "
           "所以这些代码目前还没有合并到SMathML之中."))
   (P "目前SMathML提供了一套既定的条目定义过程, "
      "并且允许用户以参数化的方式调整编号的格式. "
      "另外, 也允许用户选择是否按照条目的种类进行单独编号. "
      "美中不足的是, 引用格式被定死为了条目种类的名字加上其编号, "
      "未来或许引用格式也应该变成参数化的."
      (CodeB "(define (format-num section index local?)
  (cond ((or (eq? (car section) '*)
             (not local?))
         (if index
             (format &quot;~a&quot; index)
             #f))
                 ...
                 (apply string-append
                        (add-between
                         (map number->string
                              (cdr (reverse section))) &quot;.&quot;))
                 (if index index &quot;*&quot;)))))
(define (format-head name section index local?)
...
(define (Entry name class)
  (define (present %entry attr* . html*)
    (define local? (%entry-local? %entry))
  ...
  (lambda (#:id [id #f] #:auto? [auto? #t])
    (lambda (#:attr* [attr* '()] . html*)
      (cons (make-%entry
             (local-entry?)
             (if (separate-class?) class #f)
             id auto? #f #f present cite)
            (cons attr* html*)))))
...
(define-Entry*
  ...
  (Convention &quot;约定&quot; &quot;convention&quot;)
  (Warning &quot;警告&quot; &quot;warning&quot;))")
      "注意其中的" (Code "format-num") "和"
      (Code "format-head") "并没有provide. "
      "另外, 如今SMathML提供的此项机制也已将全局编号的条目考虑在内. "
      "然而, 鉴于许多全局编号条目 (例如参考文献) "
      "的呈现和引用方式和一般的局部编号条目均不相同, "
      "或许之后应该严肃考虑以何种方式提供对此的参数化定制.")
   (H2. "输出")
...
(define (escape*)
  ...
  (escape*))"))
   (H3. "各种" (Code "map") "变体")
   (P "以下的各种" (Code "map")
      "变体均是在使用SMathML的过程之中总结得到的."
      (CodeB "(define (map2 proc lst)
  (cond ((null? lst) '())
        ((null? (cdr lst)) (list (proc (car lst))))
        (else (cons (proc (car lst) (cadr lst))
                    (map2 proc (cddr lst))))))
...
(define Ω $Omega:normal)"))
   (H3. "最大最小")
   (P "数学中当然经常需要表达最大最小 (以及上界下界). "
      "然而, 其形式相当多样, "
      "以至于SMathML仅提供了以下定义:"
      (CodeB "(define $max (Mi &quot;max&quot;))
(define (&amp;max . x*)
  (apply appl $max x*))
(define $min (Mi &quot;min&quot;))
(define (&amp;min . x*)
  (apply appl $min x*))")
      "这当然是相当不足的, 然而也足够有用.")
   (P "现在上界下界也已加入, 等效定义如下:"
      (CodeB "(define $supremum (Mi &quot;sup&quot;))
(define $infimum (Mi &quot;inf&quot;))
(define-bigop*
  (supremum $supremum)
  (infimum $infimum))"))
   (H3. "矩阵元素的索引及其泛化")
   (P (CodeB "(define (mref A i j)
  (_ A (&amp;cm i j)))
(define (_cm A . x*)
  (_ A (apply &amp;cm x*)))")
      (Code "mref") "这种记号一般表示取矩阵的某行某列, 而"
      (Code "_cm") "可以视为" (Code "mref")
      "的更为一般的版本.")
   (H3. (Code "set-") "系函数")
   (P "SMathML提供了一些以" (Code "set-")
      "开头的便利函数, 用于修饰属性, 例如"
      (CodeB "(define (set-compact op)
  (set-attr* op 'lspace &quot;0&quot; 'rspace &quot;0&quot;))")
      ...
      "还是定义运算符的" (Code "Mi")
      "版本好, 这在MathML标准中没有交代."
      (CodeB "(define (set-mathvariant i v)
  (set-attr* i 'mathvariant v))")
      (Code "set-mathvariant")
      "可用于修改数学标识符的"
      (Code "mathvariant") "."
      (CodeB "(define (set-style x style)
...
(define (PubDate str) `(pubDate () ,str))"))
   (H3. "SXML上的一般性折叠")
   (P "这里给出的折叠在某种意义上是列表的"
      (Code "fold-left") "和" (Code "fold-right")
      "在SXML上的推广."
...
(define (Fold fdown fup fhere seed xml)
  (match xml
    (`(,tag ,attr* . ,xml*)
     (define entering
       (fdown seed tag attr* xml*))
     (define enjoying
       (fold-left
        (lambda (seed xml)
          (Fold fdown fup fhere seed xml))
        entering xml*))
     (fup seed enjoying tag attr* xml*))
    (else (fhere seed xml))))
(define (Fold* fdown fup fhere seed xml)
  (match xml
    (`(,tag ,attr* . ,xml*)
     (define-values (entering new*)
       (fdown seed tag attr* xml*))
     (define enjoying
       (fold-left
        (lambda (seed xml)
   ...
   (P "基于前一节的" (Code "Fold")
      ", 这里我们提供了一个HTML美观打印功能. "
      "当然, 你也可以将其用于XML美观打印, "
      "并且我们提供了参数" (Code "inline-tags")
      "用于控制缩进."
      (CodeB "(struct state (idt ctx) #:transparent)
(define inline-tags
  (make-parameter
   (seteq
...
(define (XML xml)
  ...
  (Fold fdown fup fhere (state 0 'block-nl) xml))")
      "这段代码里的" (Code "inline-element?")
      "主要是为了配合SMathML的使用场景. "
      "如果只是一般性的HTML和XML美观打印需求, "
      "其实可以将其去掉, 换成使用" (Code "inline?")
      "进行判断.")
   (H3. (Code "LINK") "和" (Code "TITLE"))
   (P "这些函数只是因为作者的博客频繁用到而加入的."
      (CodeB "(define (LINK title link)
...
(define (:arrow start end)
  ...
  &lt;/mrow>
&lt;/math>")
      "这正是SMathML乃至其他诸多Lisp/Scheme应用的要义, "
      "即通过抽象和组合消除思想表达之间的摩擦. "
      "另外, Lisp系语言的句法一致性免除了设计句法的烦恼.")
   (H3. "Napier筹")
...
(define (&amp;rull label . x*)
  (: (apply &amp;rule x*) label))")
   ...
   (H3. "(直觉主义命题逻辑的)自然演绎")
   (P "这里我们展示一个基于SMathML的EDSL, "
      "它可以检查证明, 然后生成对应的自然演绎树图. "
      "这个例子在其他排版系统中实现起来恐怕颇为困难."
...
(define (ND proof)
  ...
  (MB (ND (LAM $u (Neg `(disj ,$A ,(Neg $A)))
   ...
   (H3. "LAML")
   (P "LAML和SMathML在诸多想法上不谋而合, "
      "然而也存在着诸多细节差异. "
      "例如, 它选择让符号成为属性名, "
      "而符号后面跟着的字符串成为属性值. "
      "这种(具体)句法的设计或许在SMathML"
      "向其他Scheme方言/实现的移植版本中也可以采用. "
      "另外, 它选择在内容之间插入隐式的空格. "
      "这种种差异使得LAML表面上的书写句法和"
      "实际的潜在句法树之间有着较大差别, "
      "这是个人所不喜欢的. "
      )
   (H3. "(Scheme) Scribe")
   ...
   (H3. "LaTeX")
   (P "LaTeX是数学文档的事实标准, "
      "几乎所有的数学期刊和预印本网站都要求以LaTeX投稿, "
      "尽管就数学学术领域而言往往Word可以作为备选方案. "
      
      )
   (H3. "Typst")
   (H3. "SATysFi")
   (H3. "MarkDown")
   (P "MarkDown的本意可能只是提供书写简单HTML的简易方法. "
      "然而, 由于MarkDown的流行, "
      "现在的各种基于MarkDown的方案承载了太多原本没有考虑到的需求. "
      "由于MarkDown在句法设计等要素上的先天不足, "
      "这些扩展方案就个人而言显得异常丑陋. "
      )
   ))