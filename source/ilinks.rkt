...
(define ilinks.html
  (TmPrelude
   ...
   (columnize
    ...
    (H2 (A "Ben Lynn的个人主页" #:attr* '((href "https://crypto.stanford.edu/~blynn/"))))
    (H2 (A "John Harrison的个人主页" #:attr* '((href "https://www.cl.cam.ac.uk/~jrh13/"))))
    (H2 (A "Lawrence Paulson的个人主页" #:attr* '((href "https://www.cl.cam.ac.uk/~lp15/"))))
    (H2 (A "Conal Elliott的个人主页" #:attr* '((href "http://conal.net/"))))
