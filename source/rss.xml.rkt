...
(define rss.xml
  (RC #:title "愚者"
      ...
      (Item (Title "关于数组语言的随想")
            (Description "讨论了一个精神上类似于APL的嵌入式数组DSL")
            (Link "array.html"))
      (Item (Title "monad的Schemer之见")
            (Description "以Scheme语言呈现的monad教程")
            (Link "monad.html"))
      (Item (Title "程序设计的邀请")
      ...
      (Item (Title "Brzozowski导数")
            (Description "使用Brzozowski导数来parse正则表达式")
            (Link "brzozowski.html"))
      (Item (Title "SMathML参考")
            (Description "SMathML的新中文参考文档")
            (Link "smathml0.html"))
      (Item (Title "实用逻辑和自动推理手册")
            (Description "对于John Harrison的逻辑学书籍的翻译")
            (Link "automated.html"))
