...
(define cmu.html
  (Prelude
   ...
   (P "CMU的CS课程给我留下了深刻的印象, "
      ...
      "最终呈现出自然优雅的趣味.")
   (TITLE "CMU 15-122: 命令式编程原理" "cmu15122.html")
